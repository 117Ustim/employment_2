...
const services = [
  ...
  },
  {
    ...
    title: "Получение идентификационного номера (PESEL)",
    description: "Присвоение кода PESEL позволяет получить различные виды услуг. Он используется в паспортах и удостоверениях личности. Мы упрощаем процесс получения PESEL. Этот процесс занимает от 1 до 14 рабочих дней.",
  },
  {
